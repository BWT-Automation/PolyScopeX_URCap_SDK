...
@Component({
    templateUrl: './Fast-Feature-Prototype.component.html',
    styleUrls: ['./Fast-Feature-Prototype.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FastFeaturePrototypeComponent implements ApplicationPresenter, OnChanges {
    // applicationAPI is optional
    @Input() applicationAPI: ApplicationPresenterAPI;
    // robotSettings is optional
    @Input() robotSettings: RobotSettings;
    // applicationNode is required
    @Input() applicationNode: FastFeaturePrototypeNode;
